...
for payload in payloads :
    s = 'cmscond_export_iov -P /afs/cern.ch/cms/DB/conddb -s sqlite_file:RecoTauTag_MVAs_'+version+'.db -d oracle://cms_orcoff_prep/CMS_COND_PAT_001 -i '+payload+' -t '+payload
    print 'Executind command: '+s
