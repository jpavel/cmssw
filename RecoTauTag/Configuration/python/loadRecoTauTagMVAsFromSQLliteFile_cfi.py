...
loadRecoTauTagMVAsFromSQLliteFile = cms.ESSource("PoolDBESSource",
    CondDBSetup,
    DumpStat = cms.untracked.bool(False),
    toGet = cms.VPSet(),
    connect = cms.string('sqlite_file:/afs/cern.ch/work/j/jez/private/CMS/validation/140219_jetPreselection/ChristianPatch/checkAll/CMSSW_7_1_X_2014-02-19-0200/src/RecoTauTag/Configuration/data/RecoTauTag_MVAs_2014Jan24.db')
)
...
for training, gbrForestName in tauIdDiscrMVA_trainings.items():
    loadRecoTauTagMVAsFromSQLliteFile.toGet.append(
        cms.PSet(
